...
export function shell(content, activePath, appVersion = "1.0.0") {
  return raw`
    <div class="app-shell">
      <header class="app-header">
        <div class="app-header__inner">
          ...
          <nav class="nav" aria-label="Main navigation">
            ...
            <a class="nav__icon-link" href="https://github.com/KennyZhou2022/unit-converter-ui" target="_blank" rel="noreferrer" aria-label="Open GitHub repository" title="GitHub repository">
